        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              Servineo es una plataforma innovadora que hace tu vida mucho más fácil. Te conectamos
              con{' '}
              <span className="font-semibold text-[color:var(--secondary)]">
                carpinteros, fontaneros, electricistas, pintores
              </span>{' '}
              y otros expertos verificados en tu comunidad para que puedas agendar servicios de
              manera súper rápida y confiable.
            </p>
            <p className="text-base text-gray-700 leading-relaxed">
              Todos los profesionales afiliados han sido{' '}
              <span className="font-semibold text-[color:var(--accent)]">
                previamente evaluados y cuidadosamente seleccionados
              </span>
              , garantizando que siempre tengas acceso a la más selecta red de expertos.
            </p>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    Visualiza la disponibilidad de cada proveedor en tiempo real y agenda una cita
                    cuando mejor te convenga. Sin llamadas interminables, sin esperas.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">
                    ...
                    cotizaciones de especialistas interesados. Ahorra tiempo y obtén presupuestos
                    precisos.
                  </p>
                </div>
              </div>
      ...
      <section className="max-w-6xl mx-auto py-12 px-6 md:px-10">
        <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
          <div>
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-3">
              Brindar una plataforma que inspire confianza y simplifique la vida de nuestros
              usuarios, conectando necesidades reales con profesionales de calidad verificados.
            </p>
            <p className="text-base text-gray-700 leading-relaxed">
              Apostamos por la{' '}
              <span className="font-semibold text-[color:var(--accent)]">
                eficiencia, la transparencia y la mejora continua
              </span>{' '}
              en cada servicio que facilitamos.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-3">
              Nos impulsa el deseo de seguir creciendo junto a nuestra comunidad. Creemos en un
              futuro donde la tecnología empodere y las oportunidades se multipliquen.
            </p>
            <p className="text-base text-gray-700 leading-relaxed">
              Queremos ser{' '}
              <span className="font-semibold text-[color:var(--primary)]">
                el puente que transforma la manera
              </span>{' '}
              en que las personas acceden a servicios profesionales.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-5 bg-white/10 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-white/90 text-sm leading-relaxed">
                Priorizamos la transparencia y seguridad en cada interacción para que nuestros
                usuarios se sientan seguros y respaldados.
              </p>
            </div>
              ...
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M12 8c1.104 0 2-.896 2-2s-.896-2-2-2-2 .896-2 2 .896 2 2 2zM7 20v-2a4 4 0 018 0v2m-4 0v-2"
                  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-2">Calidad</h3>
              <p className="text-white/90 text-sm leading-relaxed">
                Solo trabajamos con profesionales verificados para asegurar un servicio excelente y
              ...
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M13 16h-1v-4h-1m4-2v6m-7 4h8a2 2 0 002-2v-7a2 2 0 00-2-2h-8a2 2 0 00-2 2v7a2 2 0 002 2z"
                  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-2">Innovación</h3>
              <p className="text-white/90 text-sm leading-relaxed">
                Incorporamos tecnología avanzada para facilitar conexiones rápidas y efectivas entre
